...
final class HotelController extends AbstractController
{
    ...
    {
        return $this->render('back/manager/hotel/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
{
    ...
    return $this->render('back/manager/hotel/new.html.twig', [
        'hotel' => $hotel,
        'form' => $form,
    ]);
}
    ...
    {
        return $this->render('back/manager/hotel/show.html.twig', [
            'hotel' => $hotel,
        ]);
    }
    ...
    public function edit(Request $request, Hotel $hotel, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('back/manager/hotel/edit.html.twig', [
            'hotel' => $hotel,
            'form' => $form,
        ]);
    }
